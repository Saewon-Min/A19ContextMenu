...
public class MainActivity extends AppCompatActivity {
    ...
    /*
    컨텍스트 메뉴를 전개하기 위한 메소드 오버라이딩
     */
    @Override
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {

        /*
        리소스 폴더 하위에 menu 폴더 생성 후 각 메뉴를 담당할 xml 파일을
        생성하고, 클릭된 메뉴에 따라 inflate 한다.
         */
    ...
    }//// onCreateContextMenu 메소드 끝

    // 컨텍스트 메뉴를 클릭했을때 이벤트 처리용 메소드 오버라이딩
    @Override
